        ...
        <Row>
            <Col md = {8}>
                <ListGroup variant = "flush">
                    ...
                    <ListGroup.Item>
                        <h2>Order Items</h2>
                        {order.orderItems.length === 0 ? <Message> Your cart is empty</Message> : <ListGroup variant = "flush">
                ...
                <ListGroup variant = "flush">
                    ...
                    {!order.isPaid && (
                        <ListGroup.Item>
                            {loadingPay && <Loader />}
                            {!sdkReady ? <Loader /> : (
                                <PayPalButton amount = {order.totalPrice} currency = {"NG"} onSuccess = {successPaymentHandler} />
                            )}
                        </ListGroup.Item>
                    )}
                </ListGroup>
